...
function is_ssl()
{
    return strpos(arr_get($_SERVER, 'HTTP_CF_VISITOR'), 'https') !== false || arr_get($_SERVER, 'HTTPS') === 'on' || arr_get($_SERVER, 'HTTP_X_FORWARDED_PROTO') === 'https' || arr_get($_SERVER, 'HTTP_X_FORWARDED_SSL') === 'https';
}
